...
| ~~`"air-detox garden"` survives in the DIY door's copy~~ — **RULED 2026-09-14: struck.** | The open reasoning was that here it named "something a reader might build" rather than a count of Swechha's gardens. That is what fails. **The claim itself does not hold**: houseplants do not meaningfully clean the air in a ventilated room — the idea rests on a widely-misread 1989 NASA sealed-chamber study, a 2019 Drexel review found potted plants do not improve indoor air quality, and the American Lung Association says plainly that they do not clean air. Two bands above that door the homepage publishes Delhi's air against a published limit and names the monitor; telling the same reader to detox it with a balcony garden contradicts the site's own argument inside one scroll, in a term neither source ever used. Replaced with **"a herb garden on a balcony"** — the source's own word, from Eco Action's "over 70 butterfly parks and over 20 herb gardens across Delhi NCR", and a claim about plants rather than about air. |
